 ...
 Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section class="slogan fade-down">
			<h1>Happy Birthday Nourhan !!!</h1>		
				<h2>Time left until next Birthday :</h2>
		</section>
		<!-- Slogan end here -->
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; All Rights Reserved. Made with love by afrussel & Rabih</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here 
